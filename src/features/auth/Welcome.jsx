        ...
        <div className="flex flex-col gap-10">
          <div className="flex flex-col items-start gap-5">
            <img
              src="/logo.png"
              alt="KifTari2 logo"
              className="h-36 w-36 rounded-[30px] bg-white p-4 shadow-2xl sm:h-40 sm:w-40"
            />
          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <Link
                  to="/login"
                  className="inline-flex items-center justify-center rounded-2xl bg-emerald-400 px-6 py-3 text-sm font-semibold text-slate-950 hover:bg-emerald-300"
                >
                  Continue to login
                </Link>
                <div className="rounded-2xl border border-slate-800/60 px-5 py-3 text-xs uppercase tracking-[0.24em] text-slate-400">
